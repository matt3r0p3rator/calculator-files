#ifndef TREND_DATA_HPP
#define TREND_DATA_HPP

#include "chemistry.hpp"

static const PeriodicTrend TREND_DATA[] = {
    {
        "Atomic Radius",
...
static const int NUM_TRENDS = (int)(sizeof(TREND_DATA) / sizeof(TREND_DATA[0]));

#endif // TREND_DATA_HPP
