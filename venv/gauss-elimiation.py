import copy
from gauss_elimination_lib import solve_gauss_jordan_steps, verify_solution as lib_verify_solution
...
def get_matrix_size():
    ...
    print("\n" + "=" * 39)
    print("| GAUSS-JORDAN ELIMINATION SOLVER (CLI) |")
    print("=" * 39)
...
def verify_solution_cli(original_matrix, solution, var_labels):
    ...
    all_correct, results = lib_verify_solution(original_matrix, solution)
    n_vars = len(solution)
